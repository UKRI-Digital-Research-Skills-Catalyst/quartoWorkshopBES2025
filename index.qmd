...
-   Alter the formatting of your content with Divs to create [panel figure](https://quarto.org/docs/authoring/figures.html#figure-panels) or [change figure legend locations](https://quarto.org/docs/authoring/figures.html#caption-locations)
