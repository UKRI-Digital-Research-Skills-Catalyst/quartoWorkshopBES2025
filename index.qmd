...
::: top-header
https://example.com/my-workshop-page
:::

# Housekeeping

This tutorial is available as a webpage here: [github](githublink.com)./
If you don't have R Studio installed or working, no problem! It's also
available as a positcloud instance: [positcloud](positcloudlink.com).
...
Quarto is a modern scientific publishing system for **dynamic,
reproducible documents**.

-   Write text + code together
-   Render to **HTML**, **PDF**, **Word**, **slides**, **manuscripts**,
    more
...
-   The YAML header sets the default behaviour for the document and is
    between `---` at the top of the document (more on this later)
...
+========================+=============================+
| ``` markdown           | [                           |
| [Quar                  | Quarto](https://quarto.org) |
| t                      |                             |
| o](https://quarto.org) |                             |
| ```                    |                             |
+------------------------+-----------------------------+
| ``` markdown           | !                           |
| ![Cap                  | [Caption](images/chaff.jpg) |
| t                      |                             |
| ion](images/chaff.jpg) |                             |
| ```                    |                             |
+------------------------+-----------------------------+
...
As mentioned before, the YAML determines of the settings of the qmd
document. It is defined between `---` at the top of the document.
...
🎬 If we add "See `@fig-chaff`" to our text and hit Render it'll display
as:
...
[here](https://quarto.org/docs/authoring/markdown-basics.html#sec-divs-and-spans)
...
🎬 If we add "See `@tbl-chaff`" to our text and hit Render it'll display
as:
...
-   Quarto is a multi-language scientific publishing system for
    producing dynamic, reproducible reports in many formats. It builds
    on the ideas of R Markdown.
...
-   Code can be executed interactively, allowing you to explore and
    refine analyses as you work.
...
-   You can include citations and bibliographic references directly
    within your document.

Pages made with R [@base], Quarto [@allaire2022], knitr [@knitr],
